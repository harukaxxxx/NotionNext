...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '牧野悠（ハルカ）chatgpt-next-web', // 您的昵称 例如 tangly1024
  BIO:
    process.env.NEXT_PUBLIC_BIO ||
    'おまえが何かを望む時には、宇宙全体が協力して、それを実現するために助けてくれるのだよ。', // 作者简介
  ...
  CONTACT_EMAIL:
    process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'harukaxxxx@makinoworks.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER:
    process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/haruka0495', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/harukaxxxx', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX || '%year%%month%',
  ...
  NOTION_PROPERTY_NAME: {
    ...
    type_sub_menu:
      process.env.NEXT_PUBLIC_NOTION_PROPERTY_TYPE_SUB_MENU || '子選單', // 当type文章类型与此值相同时，为子菜单。
    title: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TITLE || '標題', // 文章标题
    status: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS || '狀態',
    status_publish:
      process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_PUBLISH || '已發布', // 当status状态值与此相同时为发布，可以为中文
    status_invisible:
      process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_INVISIBLE || '隱藏', // 当status状态值与此相同时为隐藏发布，可以为中文 ， 除此之外其他页面状态不会显示在博客上
